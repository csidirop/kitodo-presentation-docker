...
if [ ! -f /initFinished ]; then
    ...
    printHeadline "Install Presentation and DFG-Viewer:"
    ...
    vendor/bin/typo3 configuration:set FE/cacheHash/requireCacheHashPresenceParameters '["tx_dlf[id]", "set[mets]"]' --json
    ...
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/fileGrpImages 'DEFAULT,DEFAULTPLUS,MASTER,MAX,ORIGINAL' # Add additional fileGrps: ORIGINAL (SLUB), MASTER (TU Braunschweig), DEFAULTPLUS (UB HD)
    ## OCR-On-Demand options:
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/fulltextFolder 'fileadmin/fulltextFolder'
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/fulltextTempFolder 'fileadmin/_temp_/ocrTempFolder/fulltext'
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/fulltextImagesFolder 'fileadmin/_temp_/ocrTempFolder/images'
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/fulltextLockFolder 'fileadmin/_temp_/ocrTempFolder/lock'
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrDebug 0 # 0 = off, 1 = on
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrDelay '0' # time in seconds
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrPlaceholder 1
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrLock 1
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrUpdateMets 0
    vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrIndexMets 0
    ## Solr options:
    if [ $solr == 1 ]; then
        vendor/bin/typo3 configuration:set EXTENSIONS/dlf/solr/host "solr" # Inside the container solr is reacheble under 'solr'
        vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrUpdateMets 1
        vendor/bin/typo3 configuration:set EXTENSIONS/dlf/ocrIndexMets 1
    fi
